...
namespace TarodevController
{
    public class PlayerAnimator : MonoBehaviour
    {
        ...
        private void HandleCrouching()
        {
            ...
            if (!_isSquishing) _sprite.size = Vector2.SmoothDamp(_sprite.size, new Vector2(1, _crouching ? _character.CrouchingHeight : _character.Height), ref _currentCrouchSizeVelocity, 0.03f);
        }
        ...
        private void OnGroundedChanged(bool grounded, float impact)
        {
            ...
            if (grounded)
            {
                ...
                _source.PlayOneShot(_splats[Random.Range(0, _splats.Length)]);
                _moveParticles.Play();
